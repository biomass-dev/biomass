...
class DifferentialEquation(object):
    ...
    def diffeq(self, t, y, *x):
        ...
        dydt[V.Ikk] = -1 * (x[C.act_Ikk_by_TNF] * y[V.TNFR] * y[V.Ikk]) + 1 * (
            x[C.trigger_iIkk] * y[V.iIkk]
        )
        dydt[V.pIkk] = 1 * (x[C.act_Ikk_by_TNF] * y[V.TNFR] * y[V.Ikk]) - 1 * (
            x[C.act_pIkk] * y[V.pIkk]
        )
        ...
        dydt[V.pNfk] = 1 * (x[C.split_NfkIkb] * y[V.pNfkpIkb]) - 1 * (
            (x[C.int_Nfk] * x[C.eta_int_pNfk]) * y[V.pNfk]
        )
        dydt[V.Nfk] = (
            1 * (x[C.split_NfkpIkb] * y[V.NfkpIkb])
            - 1 * (x[C.form_complex] * y[V.Nfk] * y[V.Ikb])
        ...
        dydt[V.mIkb] = 1 * (x[C.prod_mIkb_by_nNfk] * y[V.nNfk]) - 1 * (
            x[C.degrad_mIkb] * y[V.mIkb]
        )
        dydt[V.nIkb] = 1 * (x[C.int_Ikb] * y[V.Ikb]) * (1 / x[C.Vnuc]) - 1 * (
            x[C.form_complex_nuc] * y[V.nNfk] * y[V.nIkb]
        )
        dydt[V.pnNfk] = 1 * ((x[C.int_Nfk] * x[C.eta_int_pNfk]) * y[V.pNfk]) * (
            1 / x[C.Vnuc]
        ...
        dydt[V.nNfkIkb] = 1 * (x[C.form_complex_nuc] * y[V.nNfk] * y[V.nIkb]) - 1 * (
            x[C.ext_nNfkIkb] * y[V.nNfkIkb]
        )
        dydt[V.RnaA20_1] = 1 * (x[C.build_RnaA20] * y[V.nNfk]) - 1 * (
            x[C.shuttle_RnaA20] * y[V.RnaA20_1]
        )
        dydt[V.RnaA20] = 1 * (x[C.shuttle_RnaA20] * y[V.RnaA20_1]) - 1 * (
            x[C.degrad_RnaA20] * y[V.RnaA20]
        )
